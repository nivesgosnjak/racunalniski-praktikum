...
\newtheorem{dokaz}[izrek]{Dokaz izreka}
}
...
\begin{definicija}
   \textcolor{BrickRed}{\emph{Magični kvadrat}} reda $n$ je nabor $n^2$ različnih števil,
...
\begin{definicija}
   Magični kvadrat reda $n$ je \textcolor{BrickRed}{\emph{normalen}}, če v njem nastopajo števila
   \begin{equation}
      \label{eq:numbers} 
...
\textcolor{BrickRed}{\emph{Lo Shu}} -- ">zvitek reke Lo"<. V antični Kitajski je prišlo do
...
\textcolor{BrickRed}{\emph{Kubera-Kolam}} je talna poslikava, ki se uporablja v Indiji, in je v
...
\begin{magic}{ürerjev magični kvadrat $4\times 4$}{table:durer}{4}
   4 & 15 & 14 &  1 \\\hline
   16 &  3 &  2 & 13 \\\hline
   5 & 10 & 11 &  8 \\\hline
   9 &  6 &  7 & 12 \\\hline
...
\begin{figure}[ht!]
   ...
   \includegraphics[width=4.5cm]{sagrada.png}
   \label{fig:sagrada}
\end{figure}
...
\begin{definicija}
      ...
      v magičnem kvadratu imenujemo \textcolor{BrickRed}{\emph{magična konstanta}}.
\end{definicija}
...
\begin{definicija}
      ...
      \textcolor{BrickRed}{\emph{komplementaren}}.
\end{definicija}
...
\begin{magic}{Kvadrat Lo Shu komplementarni kvadrat}{table:closhu}{3}
   6 & 1 & 8 \\\hline
   7 & 5 & 3 \\\hline
   2 & 9 & 4 \\\hline
\end{magic}

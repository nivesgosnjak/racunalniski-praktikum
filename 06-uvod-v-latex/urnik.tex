...
\begin{enumerate}
   ...
   \item Za vse proste termine $\textnormal{predavalnice}_j$ izračunamo ceno vstavljanja
   ...
   \item Ko preverimo vse proste termine vseh predavalnic, vstavimo $\textnormal{srečanje}_i$
